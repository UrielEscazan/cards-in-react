...
function Tarjeta(props) {
  return (
    ...
    <div className="card-deck">
      ...
      <div className="card">
        <img src="https://ep01.epimg.net/cultura/imagenes/2018/04/16/actualidad/1523892028_047036_1524501429_noticia_normal.jpg" className="card-img-top" alt="La pegatina"/>
        <div className="card-body">
          <h5 className="card-title">Biografia</h5>
